	...
	name:'cluster_view',
	  data(){
        ...
        history: {
          ...
          rows: [
            {'date': "5-25", '执行任务数': '3', '集群数量': 1, '机器数量':2},
            {'date': "5-26", '执行任务数': '2', '集群数量': 1, '机器数量':2},
            {'date': "5-27", '执行任务数': '4', '集群数量': 1, '机器数量':2},
            {'date': "5-28", '执行任务数': '5', '集群数量': 1, '机器数量':2},
            {'date': "5-29", '执行任务数': '2', '集群数量': 1, '机器数量':2},
            {'date': "5-30", '执行任务数': '4', '集群数量': 1, '机器数量':2},
          ]
        },
        today: {
          columns: ['status', 'cnt'],
        ...
        tableData: [
          {name: "dclab", create_time: "2019-5-3", description: "分布式实验室集群", node_cnt: 3, submit_task: 2},
        ]
		  }
    },
    created: function() {

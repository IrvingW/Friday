	...
	name:'cluster_view',
	  data(){
        ...
        chartData: {
          ...
          rows: [
            {'date': "5-25", '执行任务数': '0', '集群数量': 1, '镜像数量': 2, '用户访问量':3},
            {'date': "5-26", '执行任务数': '0', '集群数量': 1, '镜像数量': 2, '用户访问量':2},
            {'date': "5-27", '执行任务数': '0', '集群数量': 1, '镜像数量': 2, '用户访问量':1},
            {'date': "5-28", '执行任务数': '0', '集群数量': 1, '镜像数量': 2, '用户访问量':3},
            {'date': "5-29", '执行任务数': '0', '集群数量': 1, '镜像数量': 2, '用户访问量':4},
            {'date': "5-30", '执行任务数': '0', '集群数量': 1, '镜像数量': 2, '用户访问量':4},
          ]
        }
		  }
    },
